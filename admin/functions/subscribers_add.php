...
*
* @version     $Id: subscribers_add.php,v 1.38 2007/05/15 07:03:55 rodney Exp $
	...
	*/
	function AddSubscriber_Step2($listid=0, $clear_post=false)
	{
		...
		if (!empty($customfields)) {
			$customfield_display = $this->ParseTemplate('Subscribers_Add_Step2_CustomFields', true, false);
