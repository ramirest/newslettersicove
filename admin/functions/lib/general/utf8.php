...
*
* @param string $str The string to check
* @param string $offset The offset to check the length of the next character from
* (defaults to 0)
*
* @return mixed The length of the valid utf-8 char from offset or null if the
...
* @param string $str
*
* @return mixed The length of the valid utf-8 string or null if the string
