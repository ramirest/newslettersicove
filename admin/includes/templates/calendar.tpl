	...
	<table border=0 cellspacing=0 cellpadding=0>
		<tr>
			...
			<td bgcolor="#EEEEEE" nowrap style="padding-top:5pt">
				...
				<select name="Calendar[From][Day]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomDayFrom%%</select>
				<select name="Calendar[From][Mth]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomMthFrom%%</select>
				<select name="Calendar[From][Yr]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomYrFrom%%</select>
				<span class=body>%%LNG_To%%</span>
				<select name="Calendar[To][Day]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomDayTo%%</select>
				<select name="Calendar[To][Mth]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomMthTo%%</select>
				<select name="Calendar[To][Yr]" class=CalendarSelectSmall style="margin-bottom:3px">%%GLOBAL_CustomYrTo%%</select>
				</span>&nbsp;
			</td>
