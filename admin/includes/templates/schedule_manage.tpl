...
<table cellspacing="0" cellpadding="3" width="95%" align="center">
	...
	<tr>
		<td class=body>
			<br>%%LNG_Help_ScheduleManage%%<br>
			<span id="cronscheduletime"></span><script>UpdateCronTimer('%%GLOBAL_CronTimeLeft%%', %%GLOBAL_CronTimeDifference%%, %%GLOBAL_UpdateCronTime%%);</script>
		</td>
	</tr>
	<tr>
		<td>
