...
<div class="heading1">%%LNG_Stats_NewsletterStatistics%%</div>
...
<div id="div1">
	...
	<table width="100%" border="0">
		<tr>
			<td width="45%" valign="top" rowspan="2">
				<table border=0 width="100%" class=text>
					...
					<tr class="GridRow">
						...
						<td width="70%" height="22" nowrap align="left">
							%%GLOBAL_MailingLists%%
						</td>
					</tr>
					<tr class="GridRow">
					...
					<tr class="GridRow">
						...
						<td width="70%" nowrap align="left">
							<a href="%%GLOBAL_OpensURL%%">%%GLOBAL_TotalOpens%%</a> / <a href="%%GLOBAL_UniqueOpensURL%%">%%GLOBAL_UniqueOpens%%</a>
						</td>
					</tr>
					<tr class="GridRow">
						<td width="30%" height="22" nowrap align="left" valign="top">
			...
			<td align=center class=text style="font: arial; color: #5F5F5F; padding-top:20px"><b>%%LNG_NewsletterSummaryChart%%</b></td>
