...
<body leftmargin=0 topmargin=0 marginheight="0" marginwidth="0">
	...
	<tr>
		<td class="de_body" width="70">Alt text:</td>
		<td class="de_body" width="88">
			<input type="text" id="alt_tag" size="50" class="de_Text70">
		</td>
		<td class="de_body" width="80"><?php echo sTxtBorder; ?>:</td>
		<td class="de_body" width="80">
		<input type="text" id="border" size="3" class="de_Text70" maxlength="3" value="0">
		</td>
	</tr>
	<tr>
		<td class="de_body">Width:</td>
		<td class="de_body">
			<input type="text" id="image_width" size="4" class="de_Text70" maxlength="5">
		</td>
		<td class="de_body">Height:</td>
		<td class="de_body">
			<input type="text" id="image_height" size="4" class="de_Text70" maxlength="5">
		</td>
	</tr>
	<tr>
		<td class="de_body">Horiz Space:</td>
		<td class="de_body">
			<input type="text" id="hspace" size="3" class="de_Text70" maxlength="3">
		</td>
		<td class="de_body">Vert Space:</td>
		<td class="de_body">
			<input type="text" id="vspace" size="3" class="de_Text70" maxlength="3">
		</td>
	</tr>
	<tr>
		<td class="de_body"><?php echo sTxtAlignment; ?>:</td>
		<td class="de_body">
		...
		<td class="de_body"><?php echo sTxtStyle; ?>:</td>
		<td class="de_body"><script type="text/javascript">printStyleList();</script></td>
	</tr>
	<tr>
		<td class="de_body"><?php echo sTxtTitle; ?>:</td>
		<td class="de_body"><input type="text" id="image_title" class="de_Text70"></td>
