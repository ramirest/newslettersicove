...
<tr>
<td class="de_body"><?php echo sTxtMediaWidth; ?>:</td>
<td class="de_body">
<input type="text" id="image_width" size="3" class="de_Text50" maxlength="5">
</td>
<td class="de_body"><?php echo sTxtMediaHeight; ?>:</td>
<td class="de_body">
<input type="text" id="image_height" size="3" class="de_Text50" maxlength="5">
</td>
</tr>
<tr>
<td class="de_body"><?php echo sTxtAutoStart; ?>:</td>
<td class="de_body"><input onClick="refreshState()" type=checkbox id=autostart></td><td></td><td></td>
</tr>	
<tr>
<td class="de_body"><?php echo sTxtShowControls; ?>:</td>
<td class="de_body"><input onClick="refreshState()" type=checkbox id=showcontrols></td><td></td><td></td>
</tr>	
<tr>
<td class="de_body"><?php echo sTxtShowStatusBar; ?>:</td>
<td class="de_body"><input onClick="refreshState()" type=checkbox id=showstatusbar></td><td></td><td></td>
</tr>	
<tr><td colspan=4>
