...
<BODY leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
		<table style="font-family: Arial; font-size: 11px" border="0" cellspacing="0" cellpadding="3">
		  <tr>
			<td class="de_body" width="70"><?php echo sTxtLoop; ?>:</td>
			<td class="de_body" width="88">
				<select class="de_Text70" id=loop>
			...
			<td class="de_body"><?php echo sTxtAlignment; ?>:</td>
				<td class="de_body">
				  <SELECT class=de_Text70 id="align1">
		  ...
		  <tr>
			<td class="de_body"><?php echo sTxtFlashWidth; ?>:</td>
			<td class="de_body">
			  <input type="text" id="image_width" size="3" class="de_Text70" maxlength="3">
		  </td>
			<td class="de_body"><?php echo sTxtFlashHeight; ?>:</td>
			<td class="de_body">
			  <input type="text" id="image_height" size="3" class="de_Text70" maxlength="3">
			</td>
		  </tr>
		  <tr>
			<td class="de_body"><?php echo sTxtHorizontalSpacing; ?>:</td>
			<td class="de_body">
			  <input type="text" id="hspace" size="3" class="de_Text70" maxlength="3">
			</td>
			<td class="de_body"><?php echo sTxtVerticalSpacing; ?>:</td>
			<td class="de_body">
